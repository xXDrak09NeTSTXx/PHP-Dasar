<?php  
	...
	// para meter pertama nama host data bases kedua username data base 
	// ketiga passwor username ke-empat nama data base nya
	...
	function registrasi($data)
	{
		...
		{
			echo 
				"<script>		$password = password_hash( $password, PASSWORD_DEFAULT );
		// var_dump($password);
